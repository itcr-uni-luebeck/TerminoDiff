...
public class SugiyamaLayoutFrameJava extends JFrame {

    private static final Logger log = LoggerFactory.getLogger(SugiyamaLayoutFrameJava.class);

    public SugiyamaLayoutFrameJava() {
    ...
    private VisualizationViewer<Integer, Integer> configureVisualizationViewer(
        ...
        vv.getRenderContext().setVertexLabelPosition(VertexLabel.Position.CNTR);
