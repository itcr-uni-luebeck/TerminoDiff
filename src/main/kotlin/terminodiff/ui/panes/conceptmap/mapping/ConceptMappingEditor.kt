...
@Composable
fun ConceptMappingEditorContent(localizedStrings: LocalizedStrings, conceptMapState: ConceptMapState) {
    // TODO: 23/02/22 implement concept editor
    val scrollState = rememberScrollState()
    Column(Modifier.background(colorScheme.tertiaryContainer).fillMaxSize().padding(16.dp).verticalScroll(scrollState)) {
        Text("""
        ...
        """.trimIndent(), color = colorScheme.onTertiaryContainer)
    }
}